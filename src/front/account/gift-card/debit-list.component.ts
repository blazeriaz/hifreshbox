...
export class DebitGiftCardsListComponent implements OnInit {
    ...
    loadGiftCardsList(pageNo) {
        ...
        this.searchSubscripe = this.rest.getItems(pageNo, filters, pageSize, 'wallet/mydebits', 'criteria').subscribe(GiftCards => {
