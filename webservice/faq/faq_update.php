...
$slide = json_encode(['faq' => [
						'question' => 'this is a question updated',
						'answer'=>'this is a answer updated',
						'is_active'=>1,
						'sort_order'=>1
						]]);
						
						
$ch = curl_init("http://freshbox.white-space-studio-dev.com/api/index.php/rest/V1/faqs/1");
