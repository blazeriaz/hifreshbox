...
$node = 'root'; // folder id L2NvbGxlY3Rpb24-
//$node = 'L2NvbGxlY3Rpb24-'; // folder id L2NvbGxlY3Rpb24-
$ch = curl_init("http://freshbox.white-space-studio-dev.com/api/index.php/rest/V1/media-content?node=".$node);
