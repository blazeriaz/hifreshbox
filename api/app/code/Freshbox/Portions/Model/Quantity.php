...
class Quantity extends \Magento\Framework\Model\AbstractModel implements \Freshbox\Portions\Api\Data\QuantityInterface, \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function setIsActive($is_active) {
        $this->setData(self::PORTION_STATUS, $is_active);
        return $this;
    }
    ...
    public function getCreationTime() {
        return $this->getData(self::PORTION_CREATION);
    }
    ...
    public function setCreationTime($creation_time) {
        $this->setData(self::PORTION_CREATION, $creation_time);
    }
    ...
    public function getUpdateTime() {
        return $this->getData(self::PORTION_UPDATE);
    }
    ...
    public function setUpdateTime($update_time) {
        $this->setData(self::PORTION_UPDATE, $update_time);
    }
